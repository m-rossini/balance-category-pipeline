...
* For Designning a Solution:
    ...
    * Proposals should be succint, and direct, only 1 file and the smallest and most condensed possible.
    * Proposal files should be .md files and have its name beggining with PROPOSAL_
